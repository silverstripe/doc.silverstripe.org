...
describe('Sources Docs Config', () => {
  describe('getSourceConfig', () => {
    ...
    it('should return optional feature config', () => {
      const config = getSourceConfig('6', 'staticpublishqueue', 'docs');
      expect(config).toEqual({
  ...
  describe('buildGithubEditUrl', () => {
    ...
    it('should build correct URL for optional feature staticpublishqueue', () => {
      const url = buildGithubEditUrl('6', 'index.md', 'staticpublishqueue', 'docs');
      expect(url).toBe(
    ...
    it('should build correct URL for nested optional feature path', () => {
      const url = buildGithubEditUrl('6', '02_Configuration/index.md', 'staticpublishqueue', 'docs');
      expect(url).toBe(
    ...
    it('should handle advancedworkflow with correct branch for v5', () => {
      const url = buildGithubEditUrl('5', 'index.md', 'advancedworkflow', 'docs');
      expect(url).toBe(
    ...
    it('should handle fluent with correct owner for v5', () => {
      const url = buildGithubEditUrl('5', 'index.md', 'fluent', 'docs');
      expect(url).toBe(
    ...
    it('should build correct URL for v4', () => {
      const url = buildGithubEditUrl('4', '02_Developer_Guides/index.md', undefined, 'docs');
      expect(url).toBe(
    ...
    it('should build correct URL for v3', () => {
      const url = buildGithubEditUrl('3', '02_Developer_Guides/index.md', undefined, 'docs');
      expect(url).toBe(
